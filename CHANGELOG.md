...
* [#172](https://github.com/intridea/hashie/pull/172): #update_properties is available on Dash and Trash to update their properties - [@gregory](https://github.com/gregory).
