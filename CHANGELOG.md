...
* [#586](https://github.com/hashie/hashie/pull/586): Deepmerge fix to consider hash subclasses that implement custom behavior when merging-in under an unknown key - [@addam128](https://github.com/addam128)
