...
You're reading the documentation for the next release of Hashie, which should be 3.5.6. Please read [UPGRADING](UPGRADING.md) when upgrading from a previous version. The current stable release is [3.5.5](https://github.com/intridea/hashie/blob/v3.5.5/README.md).
