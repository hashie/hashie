# This set of specs has been included inorder to verify the code that ensures
# Hashie's version of indifferent access won't get affected when Rails'
# HashWithIndifferentAccess Hash is passed in as an argument.  Refer issues
# #164 and #166
